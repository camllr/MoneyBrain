...
- Etape 5 :
  - Création d'un login avec une table users, page d'inscription/connexion et le stockard de l'user_id

- Etape 6 :
  - Installation d'une mémoire
  - Table goals liée à user_id
  - Enregistrer les objectifs depuis le récap
  - Page "Mes objectifs" + bouton "reprendre" qui recharge la session
